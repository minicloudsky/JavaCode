...
<script type="text/javascript">
	function addCart() {
		...
		location.href = "${pageContext.request.contextPath }/productServlet?method=addProductToCart&pid=${product.pid}&buyNum="
				+ buyNum;
	}
</script>
</head>
	...
	<div class="container">
		<div class="row">
			...
			<div style="width: 950px; margin: 0 auto;">
				...
				<div
					style="background-color: #d3d3d3; width: 930px; padding: 10px 10px; margin: 10px 0 10px 0;">
					<strong>商品评论</strong> <a data-toggle="modal" data-target="#Comments">[发表商品评论]</a>
				</div>
						...
						<table class="table table-bordered">
							<tbody>
								...
								<c:forEach items="${comments }" var="comment">
									<tr class="warning">
										<td><span>用户&nbsp;:&nbsp;<a>${comment.username }</a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>日期&nbsp;:&nbsp;<a>${comment.datetime }</a></span>
											<p>评论&nbsp;:&nbsp;${comment.contents }</p>
											<p>回复&nbsp;:&nbsp;${comment.reply }</p></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
				...
				<div class="modal fade" id="Comments" tabindex="-1" role="dialog"
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form role="form" action="${pageContext.request.contextPath }/productServlet?method=productComment&pid=${product.pid}&cid=${cid}&currentPage=${currentPage}" method="post">
								<div class="modal-body">
									<div class="form-group">
				                       	<label class="sr-only" for="contact-message">Message</label>
				                        <textarea style="height:100px" name="contents" placeholder="请输入..." class="contact-message form-control" id="contact-message"></textarea>
				                    </div>
			                    </div>
