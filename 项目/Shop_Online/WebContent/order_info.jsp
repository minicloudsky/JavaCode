	...
	<div class="container">
		...
		<div>
			...
			<form class="form-horizontal" id="orderForm" 
					...
					method="post"
					action="${pageContext.request.contextPath }/productServlet?method=confirmOrder">
				<input type="hidden" name="oid" value="${order.oid }" />
				<div class="form-group">
					<label for="address" class="col-sm-1 control-label" style="width:85px">地址</label>
					<div class="col-sm-5">
				...
				<div class="form-group">
					<label for="name" class="col-sm-1 control-label" style="width:85px">收货人</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" 
							id="name"
							name="name"
							placeholder="请输收货人" value="${user.receiver }">
					</div>
				</div>
				<div class="form-group">
					<label for="telephone" class="col-sm-1 control-label" style="width:85px">电话</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" 
							id="telephone"
							name="telephone"
