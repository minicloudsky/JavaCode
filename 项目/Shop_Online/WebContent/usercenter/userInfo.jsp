			...
			<ul class="nav navbar-top-links navbar-right">
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu dropdown-user">
						<li><a href="${pageContext.request.contextPath }/usercenter/userInfo.jsp"><i class="fa fa-user fa-fw"></i>
								用户信息</a></li>
		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a href="${pageContext.request.contextPath }/usercenter/address.jsp"><i class="fa fa-bar-chart-o"></i>
							收货地址</a></li>
					<li><a href="${pageContext.request.contextPath}/productServlet?method=myOrders&page=2"><i class="fa fa-table"></i> 我的订单</a>
					</li>
					<li><a href="${pageContext.request.contextPath}/userServlet?method=myComments"><i class="fa fa-edit"></i> 我的评论
					</a></li>
				</ul>
			</div>
		</nav>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">信息表单</div>
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
										<div class="row">
											...
											<form role="form" method="post"
												action="${pageContext.request.contextPath }/userServlet?method=updateUserInfo&page=1">
