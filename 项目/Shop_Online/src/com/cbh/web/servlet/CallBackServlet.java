...
public class CallBackServlet extends BaseServlet {
	...
	public void payBack(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
...
//		}
		...
		// 浏览器重定向
		response.setContentType("text/html;charset=utf-8");
		response.sendRedirect(request.getContextPath()+"/payResult.jsp");
	}
}
