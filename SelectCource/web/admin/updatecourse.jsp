...
<%
    ...
    TreeMap map =  adminDAO.getPerCource(courceid);
    TreeMap data = new TreeMap();
    if("update".equals(request.getParameter("action")))
    {
        data.put("cource_name",request.getParameter("cource_name"));
    ...
    String id = request.getParameter("cource_id");
    ...
    <div class="navbar-form">
        <form action="updatecourse.jsp?action=update" method="post">
            <table class="tab-content" style="border-collapse:separate; border-spacing:0px 10px;">
                ...
                <tr><td>课程名:&nbsp;&nbsp;<input width="150" type="text" value="<%=map.get("cource_name") %>" name="cource_name"></td></tr>
                ...
                <tr><td> <input type="hidden" name="id" value="<%= request.getParameter("cource_id") %>"></td></tr>
            </table>
        </form>
    </div>
</div>
