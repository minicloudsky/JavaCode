...
<body>
		...
		<form method="post" action="User_login.action"
			...
			<table>
				...
				<tr class="password">
					...
					<td><input type="password" name="user.password" maxlength="16"
						id="password" tabindex="2" /></td>
				</tr>
				<tr class="code">
					<td><label>验证码：</label></td>
					<td><input class="text" style="margin-right: 10px;" type=text
						value="${imageCode }" name="imageCode" id="imageCode"><img
						onclick="javascript:loadimage();" title="换一张试试" name="randImage"
						id="randImage" src="image.jsp" border="1" align="absmiddle">
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<button type="submit" tabindex="5">登录</button>
						&nbsp;&nbsp;&nbsp;&nbsp; <font id="error" style="font-size: 20px;"
	...
	<div class="bottom">
		©2017 <a href="javascript:;" target="_blank">关于</a> <span>论坛</span><img
