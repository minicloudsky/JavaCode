...
<body>
	...
	<div class="" align="center" style="margin-top: 50px;">
		...
		<form id="regForm" style="width: 700px;" enctype="multipart/form-data"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" type="text" id="nickName"
						name="user.nickName" value="${user.nickName }" /><span
						class="pull-left"></span> <font id="userErrorInfo"
						class="pull-right" color="red"></font>
				</div>
			</div>
			<div class="control-group">
			...
			<input type="hidden" name="user.type" value="1"> <input
				type="hidden" name="user.id" value="${user.id }"> <input
				type="hidden" name="user.regTime" value="${user.regTime }">
