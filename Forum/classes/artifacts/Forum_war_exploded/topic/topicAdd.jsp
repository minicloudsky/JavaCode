...
<script src="${pageContext.request.contextPath}/js/jquery.emoticons.js"
	type="text/javascript"></script>
...
<body>
	...
	<div style="width: 1200px; margin: 0 auto;">
		<table border="0" width="100%" cellspacing="0" cellpadding="0"
			style="margin-top: 8; width: 1400px;" align="center">
			<tr height="30" background="images/index/classT.jpg">
				<td style="text-indent: 5;"><b><font color="white">■
							发表帖子</font></b></td>
				<td></td>
			</tr>
			<tr>
				<td style="width: 220px;" valign="top">
					<table style="margin-top: 10; margin-left: 20px;" class="">
						<tr>
							<td valign="top" width="99%">发帖许可：<br>
							<br>
								<ul class="unstyled">
				...
				<td>
					<form class="form-horizontal" style="margin-top: 10px;"
						action="Topic_save.action" method="post"
						...
						<div class="control-group">
							...
							<div class="controls">
								<select id="section" name="topic.section.id"
									style="width: 400px;"><option value="0">请选择板块...</option>
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea name="topic.content" id="Content" class="ckeditor"
									cols="50" style="height: 200px; width: 800px;"></textarea>
							</div>
						</div>
						<input id="user" name="topic.user.id" value="${currentUser.id }"
							type="hidden" />
						<%-- <input id="section" type="hidden" name="topic.section.id" value="${curSection.id }"/> --%>
						<div class="control-group">
							<div class="controls">
								<Button class="btn btn-primary " data-dismiss="modal"
									aria-hidden="true" type="submit">提交</Button>
								<font id="error"></font>
							</div>
						</div>
					</form>
