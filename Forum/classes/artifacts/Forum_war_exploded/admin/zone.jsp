	...
	<div class="container-fluid">
		<div id="tooBar" style="padding: 10px 0px 0px 10px;">
			<button class="btn btn-primary" type="button" data-backdrop="static"
				data-toggle="modal" data-target="#dlg" onclick="return openAddDlg()">添加大板块</button>
			&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
		<div class="row-fluid">
			<div class="span12">
									...
									<tr>
										...
										<td style="text-align: center;">
											<button class="btn btn-info" type="button"
												...
												data-target="#dlg"
												onclick="return modifyZone(${zone.id},'${zone.name }','${zone.description }')">修改
											</button>&nbsp;&nbsp;
											<button class="btn btn-danger" type="button"
												onclick="javascript:zoneDelete(${zone.id})">删除</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
		...
		<div id="dlg" class="modal hide fade" tabindex="-1" role="dialog"
			...
			<div class="modal-body">
				<form id="fm" action="">
					<table>
						<tr>
							<td><label class="control-label" for="zoneName">请输入大板块名称：</label>
							</td>
							<td><input id="zoneName" type="text" name="zone.name"
								placeholder="请输入…"></td>
						</tr>
						<tr>
							<td><label class="control-label" for="description">请输入备注：</label>
							</td>
							<td><textarea rows="5" cols="50" style="width: 405px;"
									id="description" name="zone.description"></textarea></td>
						</tr>
					</table>
