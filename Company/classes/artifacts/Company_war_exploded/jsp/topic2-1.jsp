...
<html>
  <head>
    ...
    <title>My JSP 'topic2-1.jsp' starting page</title>
  ...
  <body>
			...
			<tr>
				<td colspan="4">
					<table>
						<tr align="center">
							<td rowspan="5"><img src="${pageContext.request.contextPath}/<%=product.getImg()%>" width="60%" height="60%"/></td>
							<td></td>
						</tr>
						<tr align="left">
							<td></td>
							<td><font size="5"><strong>编号:<%=product.getPid()%></strong></font></td>
						</tr>
						<tr>
							<td></td>
							<td><font size="5"><strong>名称:<%=product.getPname()%></strong></font></td>
						</tr>
						<tr>
							<td></td>
							<td><font size="5"><strong>净重:<%=product.getWeight()%></strong></font></td>
						</tr>
						<tr>
							<td></td>
							<td><font size="5"><strong>产区:<%=product.getArea()%></strong></font></td>
						</tr>
					</table>
				</td>
			</tr>
